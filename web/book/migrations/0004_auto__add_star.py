...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'book_star', (
            ...
            ('book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stars', to=orm['book.Book'])),
        ))
        db.send_create_signal(u'book', ['Star'])


    def backwards(self, orm):
        # Deleting model 'Star'
        db.delete_table(u'book_star')
    ...
    models = {
        ...
        u'book.star': {
            'Meta': {'ordering': "['-create_at']", 'object_name': 'Star'},
