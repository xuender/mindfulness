...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'book_userprofile', 'type')

        # Deleting field 'UserProfile.id'
        db.delete_column(u'book_userprofile', u'id')

        # Adding field 'UserProfile.note'
        db.add_column(u'book_userprofile', 'note',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'UserProfile.user'
        db.alter_column(u'book_userprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True))

    def backwards(self, orm):
        # Adding field 'UserProfile.type'
        db.add_column(u'book_userprofile', 'type',
                      self.gf('django.db.models.fields.CharField')(default='n', max_length=1),
                      keep_default=False)

        # Adding field 'UserProfile.id'
        db.add_column(u'book_userprofile', u'id',
                      self.gf('django.db.models.fields.AutoField')(default='', primary_key=True),
                      keep_default=False)

        # Deleting field 'UserProfile.note'
        db.delete_column(u'book_userprofile', 'note')


        # Changing field 'UserProfile.user'
        db.alter_column(u'book_userprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
