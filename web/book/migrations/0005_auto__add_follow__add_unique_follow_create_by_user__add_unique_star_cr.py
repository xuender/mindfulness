...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'book', ['Follow'])

        # Adding unique constraint on 'Follow', fields ['create_by', 'user']
        db.create_unique(u'book_follow', ['create_by_id', 'user_id'])

        # Adding unique constraint on 'Star', fields ['create_by', 'book']
        db.create_unique(u'book_star', ['create_by_id', 'book_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Star', fields ['create_by', 'book']
        db.delete_unique(u'book_star', ['create_by_id', 'book_id'])
