...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Annotation.length'
        db.alter_column(u'book_annotation', 'length', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Annotation.length'
        db.alter_column(u'book_annotation', 'length', self.gf('django.db.models.fields.IntegerField')(null=True))
