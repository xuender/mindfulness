...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Annotation.style'
        db.add_column(u'book_annotation', 'style',
                      self.gf('django.db.models.fields.CharField')(default='l', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Annotation.style'
        db.delete_column(u'book_annotation', 'style')
    ...
    models = {
        ...
        u'book.annotation': {
            ...
            'style': ('django.db.models.fields.CharField', [], {'default': "'l'", 'max_length': '1'})
        },
        u'book.book': {
