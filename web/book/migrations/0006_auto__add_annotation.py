...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'book_annotation', (
            ...
            ('chapter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='anotations', to=orm['book.Chapter'])),
        ...
        db.send_create_signal(u'book', ['Annotation'])


    def backwards(self, orm):
        # Deleting model 'Annotation'
        db.delete_table(u'book_annotation')
