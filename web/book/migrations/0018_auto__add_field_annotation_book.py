...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Annotation.book'
        db.add_column(u'book_annotation', 'book',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='annotations', to=orm['book.Book']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Annotation.book'
        db.delete_column(u'book_annotation', 'book_id')
