...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Annotation.seat'
        db.delete_column(u'book_annotation', 'seat')

        # Deleting field 'Annotation.length'
        db.delete_column(u'book_annotation', 'length')

        # Adding field 'Annotation.start'
        db.add_column(u'book_annotation', 'start',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Annotation.end'
        db.add_column(u'book_annotation', 'end',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Annotation.seat'
        db.add_column(u'book_annotation', 'seat',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Annotation.length'
        db.add_column(u'book_annotation', 'length',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Annotation.start'
        db.delete_column(u'book_annotation', 'start')

        # Deleting field 'Annotation.end'
        db.delete_column(u'book_annotation', 'end')
    ...
    models = {
        ...
        u'book.annotation': {
            'Meta': {'ordering': "['start']", 'object_name': 'Annotation'},
