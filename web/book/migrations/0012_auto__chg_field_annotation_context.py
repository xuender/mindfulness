...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Annotation.context'
        db.alter_column(u'book_annotation', 'context', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Annotation.context'
        db.alter_column(u'book_annotation', 'context', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        u'book.annotation': {
            'Meta': {'ordering': "['row', 'start']", 'object_name': 'Annotation'},
