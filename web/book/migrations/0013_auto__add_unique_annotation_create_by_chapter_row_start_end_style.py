...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Annotation', fields ['create_by', 'chapter', 'row', 'start', 'end', 'style']
        db.create_unique(u'book_annotation', ['create_by_id', 'chapter_id', 'row', 'start', 'end', 'style'])


    def backwards(self, orm):
        # Removing unique constraint on 'Annotation', fields ['create_by', 'chapter', 'row', 'start', 'end', 'style']
        db.delete_unique(u'book_annotation', ['create_by_id', 'chapter_id', 'row', 'start', 'end', 'style'])
